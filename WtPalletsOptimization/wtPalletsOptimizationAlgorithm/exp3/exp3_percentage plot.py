...
# Labels and title
plt.title('Experiment 3: Percentage of Average Waiting Time vs. Number of Passengers (with Optimised Pod)')
...
# Save the plot
plt.savefig('percentage_waiting_time_comparison_exp3_pod_opt.png')
