...
def main_simulation(total_passenger_count, capacity):
    ...
    conn.commit()
    print(f"{total_passenger_count} Passengers added successfully for capacity {capacity} (70% from {desti_stop}, 30% from others).")
