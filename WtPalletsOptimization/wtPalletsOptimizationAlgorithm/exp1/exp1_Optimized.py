...
csv_files = [
    f"{count}_exp1.csv" for count in pallet_counts
]
        ...
        if goodspods_at_same_stop:
            ...
            for goodspod_id, (goodspod_loc, goodspod_free_time) in active_goodspods.items():
                ...
                if goodspod_arrival_time <= arrival_time:
                    deliver_delay = arrival_time - goodspod_arrival_time
                    candidates.append((deliver_delay, goodspod_id, goodspod_loc, goodspod_free_time, time_to_reach, goodspod_arrival_time))
